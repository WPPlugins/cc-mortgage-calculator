...
This simple [mortgage calculator](http://mortgage.calculatorscanada.ca) calculates mortgage monthly payments. 
...
Please [contact us](http://calculatorscanada.ca/contact) if you have further questions or suggestions. In case you have an issue with this plugin please send us WordPress version, the name of theme and list of plugins you are using.
